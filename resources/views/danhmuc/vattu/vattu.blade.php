...
<div class="span16" >
        ...
        <table class="table table-bordered table-hover tablesorter" id="sample-table">
            <thead style="background:#EFEFEF;">
                <tr>
                    <th class="header headerSortDown" class="span3">Mã SP</th>
                    <th class="td-actions header" class="span4">Tên SP</th>
                    <th class="td-actions header">Đơn vị tính</th>
                    <th class="td-actions header" class="span3">Nhóm sản phẩm</th>
