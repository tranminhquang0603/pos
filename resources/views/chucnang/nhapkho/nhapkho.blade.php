...
<div class="row">
        ...
        <div class="box">
            ...
            <div class="box-content">
                <form class="form-inline">
                    <p><b>Nhập hàng</b></p>
                        <a href="{!! URL::route('chucnang.nhapkho.getList') !!}"><i class="icon-plus"></i>&nbspNhập hàng</a><br><br>
                    <p><b>Bảng kê nhập</b></p>
                        <a href="{!! URL::route('chucnang.nhapkho.getVattu') !!}"><i class="icon-plus"></i>&nbspTheo sản phẩm</a><br>
    ...
    <div style="margin-left:-1px" class="span13">
        <div class="box">
            <div class="box-header">
                <p><b>Nhập hàng thông thường</b></p>
            </div>
            <div class="box-content">
                            ...
                            <form action="" method="POST" accept-charset="utf-8">
                                ...
                                <div id="acct-password-row" class="span8">
                                    <fieldset>
                                        ...
                                        <div class="control-group">
                                            <label>Ghi chú:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label>
                                ...
                                <div id="acct-password-row" class="span4">
                                    <fieldset>
                                        <div class="control-group ">
                                            ...
                                            <input type="text" name="txtID" value="PNH{!! date('dmYhms') !!}" class="span3">
                                        </div>
                                        <div class="control-group">
