        ...
        <div class="box">
            ...
            <div class="box-content">
                <form class="form-inline">
                    <p><b>Bán hàng</b></p>
                        <a href="{!! URL::route('chucnang.xuatkho.getList') !!}"><i class="icon-plus"></i>&nbspBán hàng</a><br><br>
                    <p><b>Bảng kê xuất</b></p>
                        <a href="{!! URL::route('chucnang.xuatkho.getVattu') !!}"><i class="icon-plus"></i>&nbspTheo sản phẩm</a><br>
                        ...
                        <div class="row">
                            ...
                            <form action="" method="POST" accept-charset="utf-8">
                                ...
                                <div id="acct-password-row" class="span8">
                                    <fieldset>
                                        <div class="control-group">
                                            <label>Khách hàng:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label>
                                            <input type="text" name="txtDC" class="span7">
                                        </div>
                                        <div class="control-group">
                                            <label>Ghi chú:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label>
                                ...
                                <div id="acct-password-row" class="span4">
                                    <fieldset>
                                        <div class="control-group ">
                                            <label>Mã hóa đơn:&nbsp</label>
                                            <input type="text" name="txtID" value="HD{!! date('dmYhms') !!}" class="span3">
                                        </div>
                                        <div class="control-group">
                                ...
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    ...
                                    <div>
                                        <u><p><b>Danh sách sản phẩm</b></p></u>
                                    </div>
                                    <div class="control-group">
                                        <label>Mã:</label>
